...
function Process({ site }) {
  ...
  // Auto-fold once the reader scrolls past the open scroll. Because it is
  // off-screen at that point, collapse INSTANTLY and shift the scroll
  // position by the collapsed height — content below (the founder section
  // and its scroll-driven photo) stays perfectly still in the viewport.
  useEffect(() => {
    if (!open) return;
    const onScroll = () => {
      ...
      if (!el) return;
      const r = el.getBoundingClientRect();
      if (r.bottom < (innerHeight || 800) * 0.18) {
        const h = r.height;
        setNoAnim(true);
        setOpen(false);
    ...
    <section id="process">
      <div style={{ width: "100%" }}>
        ...
        <div className="scrollbox">
          ...
          <div ref={wrapRef} className={"scrollwrap" + (open ? " sopen" : "") + (noAnim ? " noanim" : "")}>
