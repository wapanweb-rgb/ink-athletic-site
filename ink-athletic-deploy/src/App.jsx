  ...
  return (
    <div className="scardwrap">
      <div className={"scard" + (open ? " sopen" : "")} style={{ transitionDelay: delay + "s" }}>
        ...
        <span className="sglyph" aria-hidden="true" style={{ animationDelay: (i * 0.8) + "s" }}>{GLYPHS[i % GLYPHS.length]}</span>
