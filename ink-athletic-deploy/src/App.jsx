        ...
        <div className="lockup">
          <svg className="lmark" viewBox="0 0 98 88" aria-hidden="true">
            <defs>
              ...
              <linearGradient id="lmS" x1="0" y1="0" x2="1" y2="1">
