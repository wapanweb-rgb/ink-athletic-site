...
function ChainLink() {
  return (
    <svg viewBox="0 0 16 36" fill="none" stroke="#8E939C" strokeWidth="2.4">
      <ellipse cx="8" cy="10" rx="5" ry="7.6" />
      <ellipse cx="8" cy="26" rx="5" ry="7.6" stroke="#6C7078" />
    </svg>
  );
}

const GLYPHS = [
  <svg viewBox="0 0 80 80" fill="none" stroke="currentColor" strokeWidth="1.6"><circle cx="40" cy="40" r="14" /><circle cx="40" cy="26" r="14" /><circle cx="52" cy="33" r="14" /><circle cx="52" cy="47" r="14" /><circle cx="40" cy="54" r="14" /><circle cx="28" cy="47" r="14" /><circle cx="28" cy="33" r="14" /></svg>,
  <svg viewBox="0 0 80 80" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M40 12L68 62H12z" /><circle cx="40" cy="45" r="10" /><path d="M40 12v23" /></svg>,
  <svg viewBox="0 0 80 80" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M40 40m-4 0a4 4 0 1 1 8 0a8 8 0 1 1-16 0a12 12 0 1 1 24 0a16 16 0 1 1-32 0a20 20 0 1 1 40 0a24 24 0 1 1-48 0" /></svg>,
  <svg viewBox="0 0 80 80" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="16" y="16" width="48" height="48" /><rect x="26" y="26" width="28" height="28" /><rect x="36" y="36" width="8" height="8" /><path d="M16 16l10 10M64 16l-10 10M16 64l10-10M64 64l-10-10" /></svg>,
  <svg viewBox="0 0 80 80" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M12 48l14-20 10 12 10-24 12 32" /><path d="M12 60h56M12 54h56" strokeDasharray="4 5" /></svg>,
  <svg viewBox="0 0 80 80" fill="none" stroke="currentColor" strokeWidth="1.6"><ellipse cx="40" cy="40" rx="28" ry="16" /><circle cx="40" cy="40" r="9" /><circle cx="40" cy="40" r="3" /><path d="M12 40h-6M74 40h-6" /></svg>
];
  ...
  return (
    <div className="scardwrap">
      <div className={"scard" + (open ? " sopen" : "")} style={{ transitionDelay: delay + "s" }}>
        <span className="chain cl" aria-hidden="true"><ChainLink /></span>
        <span className="chain cr" aria-hidden="true"><ChainLink /></span>
        <span className="sglyph" aria-hidden="true">{GLYPHS[i % GLYPHS.length]}</span>
    ...
    <section id="process">
      <div style={{ width: "100%" }}>
        ...
        <div className="scrollbox">
          ...
          <div className={"scrollwrap" + (open ? " sopen" : "")}>
