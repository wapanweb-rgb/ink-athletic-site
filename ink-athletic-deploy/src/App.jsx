  ...
  return (
    <section id="team">
      <div style={{ width: "100%" }}>
        ...
        <div ref={ref} className={"team-card reveal" + (inView ? " in" : "")}>
          <div className="tronframe">
...
const emptyDraft = { id: "", name: "", outcome: "", line: "", price: "", features: "", art: "kiosk", addOns: "", image: "", category: CATEGORIES[0], buy: false, weightG: "", boxL: "", boxW: "", boxH: "" };
            ...
            {products.map(p => (
              <div className="admin-row" key={p.id}>
                <div>
                  ...
                  <div className="am">{p.category ? p.category + " · " : ""}${p.price.toLocaleString()} · {p.features.length} features{p.addOns?.length ? ` · ${p.addOns.length} add-on` : ""}{p.buy ? " · 🛒 in cart" : ""}</div>
                </div>
                <div className="abtns">
