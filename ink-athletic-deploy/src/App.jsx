      ...
      <div style={{ width: "100%" }}>
        ...
        <div ref={ref} className={"team-card reveal" + (inView ? " in" : "")}>
          <div className="team-photo">
            {f.photo
              ? <img src={f.photo} alt={f.name || "Founder"} />
...
const emptyDraft = { id: "", name: "", outcome: "", line: "", price: "", features: "", art: "kiosk", addOns: "", buy: false, weightG: "", boxL: "", boxW: "", boxH: "" };
...
function SiteForm({ site, setSite }) {
  ...
  return (
    <div className="admin-form">
      ...
      <div className="field"><label>Photo URL (leave blank to show a placeholder)</label><input value={draft.founder.photo} onChange={setObj("founder", "photo")} placeholder="https://…/your-photo.jpg" /></div>
