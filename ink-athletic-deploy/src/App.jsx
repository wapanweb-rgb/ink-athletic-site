      ...
      <div className={"scard" + (open ? " sopen" : "")} style={{ transitionDelay: delay + "s" }}>
        ...
        {marks.map((m, k) => (
          <span key={k} className="sglyph" aria-hidden="true"
            style={{ left: m.left + "%", top: m.top + "%", width: m.size + "px", height: m.size + "px", transform: "rotate(" + m.rot + "deg)", animationDelay: m.delay + "s", animationDuration: m.dur + "s" }}>
            {GLYPHS[m.g]}
          </span>
        ))}
