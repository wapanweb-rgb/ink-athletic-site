  ...
  return (
    <>
      ...
      <aside className={"drawer" + (open ? " open" : "")} aria-hidden={!open}>
        ...
        <h3>Your Cart</h3>
        <div className="sub">Shipping &amp; tax calculated at checkout</div>
...
function Nav({ count, cartCount, onQuoteOpen, onCartOpen, onHome, isHome, ready }) {
...
export default function App() {
  ...
  return (
    <>
      <style>{CSS}</style>
      {!isAdminRoute && (
        <Nav count={count} cartCount={cartCount} onQuoteOpen={() => setDrawer(true)} onCartOpen={() => setCartOpen(true)} onHome={goHome} isHome={!product} ready={belowFold} />
      )}
