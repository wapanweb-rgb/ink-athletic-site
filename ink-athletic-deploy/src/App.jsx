...
function Storefront({ site, products, onOpen, onQuote, onBuy }) {
  ...
  return (
    <section id="store">
      ...
      <div className="pgrid">
        {products.map((p, i) => (
          <ProductCard key={p.id} p={p} i={i} onOpen={onOpen} onQuote={onQuote} onBuy={onBuy} />
        ))}
      </div>
...
const emptyDraft = { id: "", name: "", outcome: "", line: "", price: "", features: "", art: "kiosk", addOns: "", image: "", buy: false, weightG: "", boxL: "", boxW: "", boxH: "" };
...
function SiteForm({ site, setSite }) {
  ...
  return (
    <div className="admin-form">
      ...
      <h3 style={{ marginTop: 24 }}>About / Founder section</h3>
      <div className="grid2">
            ...
            {products.map(p => (
              <div className="admin-row" key={p.id}>
                <div>
                  ...
                  <div className="am">${p.price.toLocaleString()} · {p.features.length} features{p.addOns?.length ? ` · ${p.addOns.length} add-on` : ""}{p.buy ? " · 🛒 in cart" : ""}</div>
                </div>
                <div className="abtns">
