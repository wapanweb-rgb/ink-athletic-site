    ...
    <footer>
      ...
      <div className="f-grid">
        ...
        <div className="f-col">
          ...
          <a href="/web-design-fort-st-john">Web design in Fort St. John</a>
...
/* Local SEO landing page — the dedicated page for "web design fort st john"
   and related searches. Real content, real links, crawlable at its own URL. */
function WebDesignPage({ site, onBack }) {
  useEffect(() => { window.scrollTo(0, 0); }, []);
  return (
    <div className="seopage">
      <p className="seyebrow">Fort St. John · Peace Region · Northern BC</p>
      <h1>Web Design in Fort St. John, BC</h1>
      <p className="slead">
        Ink Athletic Ltd. is a Fort St. John web design and software company. We build fast,
        mobile-first websites with e-commerce, online booking, and content you can edit yourself —
        engineered from scratch for your business, never squeezed into a template.
      </p>
      <div className="sbtns">
        <a className="btn solid" href={"mailto:" + site.email}>Get a free quote</a>
        <a className="btn" href="/" onClick={(e) => { e.preventDefault(); onBack(); }}>See our work</a>
      </div>

      <h2>What your website includes</h2>
      <ul>
        <li><strong>Custom design</strong> — built around your brand, not a theme thousands of sites already use.</li>
        <li><strong>Mobile-first &amp; fast</strong> — most local customers find you on a phone; your site is engineered for it.</li>
        <li><strong>E-commerce ready</strong> — take payments, calculate real shipping rates, and sell across Canada.</li>
        <li><strong>Editable by you</strong> — change text, photos, and products yourself, no developer needed.</li>
        <li><strong>Search-engine ready</strong> — structured data, sitemaps, and local SEO set up from day one.</li>
        <li><strong>AI where it helps</strong> — chat assistants, automation, and interactive kiosks when your business is ready.</li>
      </ul>

      <h2>A local team, not an agency queue</h2>
      <p>
        We're based at 9711 100th Ave in Fort St. John and work with businesses across the Peace
        Region — Fort St. John, Dawson Creek, Taylor, Charlie Lake, Hudson's Hope, and remote-first
        clients anywhere in British Columbia. When you call, you talk to the person who builds your
        site. Founder Brandon Cameron trained in Marketing and Advertising at UBC and builds
        everything from small business websites to AI-engineered software and interactive kiosks.
      </p>

      <h2>Web design pricing in Fort St. John</h2>
      <p>
        Every quote is custom because every business is different — but you'll always know the
        price before we start, and we build in stages so you're never surprised. Tell us what you
        need and we'll send a clear, itemized quote within a couple of days.
      </p>

      <h2>More than websites</h2>
      <p>
        Web design is where most clients start — then we help them grow: online stores with live
        shipping rates, business automation, custom software, 3D printing, and AI kiosks for
        storefronts. One local partner for the whole stack. Read about our{" "}
        <a href="/green">local-first, sustainable approach</a> to technology.
      </p>

      <div className="sbtns">
        <a className="btn solid" href={"mailto:" + site.email}>{site.email}</a>
      </div>
    </div>
  );
}
...
const routeFromPath = () => {
  ...
  if (p === "/web-design-fort-st-john") return { page: "webdesign" };
...
const pathFromRoute = (r) => {
  ...
  if (r.page === "webdesign") return "/web-design-fort-st-john";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    else if (route.page === "webdesign") document.title = "Web Design Fort St. John, BC | Ink Athletic Ltd.";
    else if (product) document.title = product.name + " | Ink Athletic Ltd.";
    else if (isAdminRoute) document.title = "Admin | Ink Athletic Ltd.";
    else document.title = "Web Design & AI Engineering in Fort St. John, BC | Ink Athletic Ltd.";
  ...
  return (
    <>
      ...
      {isAdminRoute ? (
        ...
        <WebDesignPage site={site} onBack={goHome} />
      ) : product ? (
