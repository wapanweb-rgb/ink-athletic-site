...
const GLYPHS = [
  <g><path d="M22 52c6-3.5 15-4.5 24-3" /><path d="M25 52l-3.5 14M33 51l-2 15M43 50.5l1.5 15M52 50l3.5 13" /><path d="M46 49c4-2 7.5-6 8.5-11" /><path d="M54.5 38c-1.5-7 2.5-13.5 8.5-16.5M54.5 38c3-6.5 9.5-9.5 15.5-9" /><path d="M22 52c-4.5-1-6.5-5-5.5-9.5" /><path className="fine" d="M28.5 49.5l2.5 3.5M34 48.5l2.5 3.5M39.5 48l2.5 3.5M45 47.5l2.5 3.5" /><circle className="fine" cx="52.5" cy="42.5" r="1" /><path className="fine" d="M50.5 43.5l-3-2" /><path className="fine" d="M14 69h8M27 69h10M42 69h9M55 69h11" /></g>,
  <g><path d="M31 13.5c3-2 6.5-.5 7 3s-2.5 6.5-6 6-5.5-4-4.5-7" /><path d="M34 23c-1.5 9-1 16 .5 24" /><path d="M34 30.5l-10.5 8M34.5 30l11 6.5" /><path d="M34.5 47l-8.5 15.5M34.5 47l9.5 14" /><path d="M50 15c9 8 9 24 0 32" /><path className="fine" d="M50 15.5v31" /><path className="fine" d="M34.5 31l18.5 7.5" /><path className="fine" d="M53 38.5l-4.5-.5M53 38.5l-2.5-3" /><path className="fine" d="M31 11l-2.5-5M35 10.5l.5-5.5M38.5 12l3-4.5" /></g>,
  <g><path d="M30 62c-4.5-8-5.5-16-4-24.5" /><path d="M26 38l-4.5-12.5" /><path d="M33 36.5l-2.5-16.5" /><path d="M40 36l1-17.5" /><path d="M47 37.5l4.5-14" /><path d="M52.5 42l7.5-8.5" /><path d="M30 62c8.5 3.5 16.5 2.5 21.5-3 2-6 2-12.5 1-17.5" /><path className="fine" d="M31 50.5c4 2 9 2 13-1M30 44.5c5 2 10 2 15-1" /><circle className="fine" cx="18" cy="26" r="1.1" /><circle className="fine" cx="58.5" cy="23.5" r="1" /><circle className="fine" cx="62.5" cy="52" r="1.2" /><circle className="fine" cx="21.5" cy="60.5" r="1" /><circle className="fine" cx="15" cy="45" r=".9" /></g>,
  <g><path d="M40 40c1.5-4 6-5.5 9.5-2.5 4 4 2.5 11-3 13.5-7.5 3-15.5-2-16.5-10-1.5-10.5 8-18.5 18.5-17.5 12 1 19.5 12 17.5 23.5" /><path className="fine" d="M40 8v-5M62 15.5l3.5-3.5M72 40h5M62.5 64.5l3.5 3.5M40 72v5M17.5 64.5L14 68M8 40H3M17.5 15.5L14 12" /><circle className="fine" cx="42.5" cy="42.5" r="1.2" /></g>,
  <g><path d="M14 40.5c8.5-9.5 17.5-13.5 26.5-13.5s17.5 4.5 25.5 13c-8.5 8-17.5 12-26.5 12s-17.5-4-25.5-11.5z" /><circle cx="41" cy="39.5" r="6.5" /><circle className="fine" cx="41" cy="39.5" r="2.4" /><path d="M12 30c9-8 20-11 30-10.5 9 .4 17 3.5 24 8" /><path d="M62 47.5c3.5 5.5 2.5 10-2 13.5-3 2-6.5 1-7.5-2" /><path d="M30 52.5l-3 9c-1 3-4 4-6 2" /><path className="fine" d="M22 33.5l-2.5-3M31 29.5l-1.5-3.5M50 29.5l1.5-3.5M59 33.5l2.5-3" /></g>,
  <g><path d="M14 58c6.5-6 12.5-6.5 18.5-1.5s12.5 5.5 18.5-.5 9.5-11 8-18.5c-1.5-6.5-6.5-9.5-11.5-7.5" /><circle className="fine" cx="48.5" cy="30.5" r="1" /><path className="fine" d="M46 33l-7 4M39 37l-2.5-.5M39 37l-.5 2.5" /><path className="fine" d="M20 55.5l2-3M26 53.5l2-3M32 53.5l2-3M38 54.5l2-3M44 53l2-3M50 50l2.5-2.5M55.5 45l2.5-2M58.5 39l2.5-1.5" /></g>,
  <g><path d="M26.5 58c-5.5-6.5-6.5-14.5-2-20.5 4-5.5 11-7 17-4l7.5 4" /><path d="M48.5 38c5 2.5 8.5.5 10.5-3.5" /><path d="M58.5 34.5c3.5-1 6.5.5 8 3.5" /><path d="M30 58.5l-2.5 10.5M38 58l.5 11" /><path className="fine" d="M27.5 69l-3 2.5M27.5 69l2.5 3M38.5 69l-2.5 3M38.5 69l3 2.5" /><path className="fine" d="M26 46.5c5-2 10-2 15 0M25 51.5c6-1.5 12-1.5 17 .5M28 41.5c4-2 8-2.5 12-1" /><circle className="fine" cx="62" cy="36.5" r=".9" /><path d="M24.5 44.5L12 40" /></g>,
  <g><path d="M11.5 30l9.5-10 9 10.5 9.5-10 9 10 9.5-10.5 9 10" /><path d="M12 46l9-9.5 9.5 9 9-9.5 9.5 9.5 9-9 9.5 9.5" /><path className="fine" d="M12.5 60l9-9 9.5 8.5 9-9 9.5 9 9-8.5 9.5 9" /><circle className="fine" cx="20" cy="66.5" r="1" /><circle className="fine" cx="40" cy="68.5" r="1" /><circle className="fine" cx="60" cy="66.5" r="1" /></g>
];
...
function ProcessCard({ s, i, open, total }) {
  ...
  useEffect(() => {
    const place = () => {
      ...
      tryPlace(48, 118, 280);         // big marks first
      if (placed.length < 3) tryPlace(26, 56, 220); // squeeze smaller ones into leftover gaps
      setMarks(placed);
